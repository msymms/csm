...
if ( ! function_exists( 'scsdesigns_csm_posted_on' ) ) :
	...
	function scsdesigns_csm_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'scsdesigns-csm' ),
...
if ( ! function_exists( 'scsdesigns_csm_posted_by' ) ) :
	...
	function scsdesigns_csm_posted_by() {
		$byline = sprintf(
			...
			esc_html_x( 'by %s', 'post author', 'scsdesigns-csm' ),
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'scsdesigns-csm' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'scsdesigns-csm' ),
					array(
						'span' => array(
							'class' => array(),
						),
 ...
 */
function scsdesigns_csm_post_thumbnail() {
